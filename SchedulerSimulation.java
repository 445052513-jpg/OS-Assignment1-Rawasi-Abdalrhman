...
class Process implements Runnable {
    ...
    private int priority; //Featuer 1: Added priority attribute for each process
    ...
    public Process(String name, int burstTime, int timeQuantum) {
        ...
        this.priority= 1 + new Random().nextInt(5);// Random priority betwen 1 and 5(1 = highest priority)
    }
...
public class SchedulerSimulation {
    ...
    public static void main(String[] args) {
        ...
        int studentID = 445052513;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        while (!processQueue.isEmpty()) {
            ...
            contextSwitchCount++;//Featuer 2:Increment context switch count
        ...
        System.out.println(Colors.BOLD + Colors.BRIGHT_GREEN + 
                          "╚════════════════════════════════════════════════════════════════════════════════╝" + 
                          Colors.RESET + "\n");
       System.out.println("Total context switches:"+ contextSwitchCount);//Feature 2: print total context switches
    }
